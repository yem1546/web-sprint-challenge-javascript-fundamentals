...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Because the nestedFunction is created within myFunction it has access to the external scope
...
const zooAnimals = [
  ...
  */
  ...
  💡 NOTE: Remember the reduce method takes two arguments: a callback (which itthis takes two args - the accumulator and the item), and an initial value for the count. Check MDN/W3Schools for syntax!
  */
